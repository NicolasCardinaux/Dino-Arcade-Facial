            ...
            <body>
                ...
                <div id="leaderboard-container">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 5px; margin-bottom: 15px;">
                        <div style="display: flex; gap: 5px;">
                            <input type="text" id="player-name" placeholder="Nombre (obligatorio)" style="flex:1; padding: 8px; border-radius: 6px; border: 2px solid #ccc; font-weight: bold; font-size: 14px;"/>
                            <button id="btn-add-player" onclick="addPlayer()" style="background: #2196f3; color: white; border: none; border-radius: 6px; padding: 0 15px; font-weight: bold; cursor: pointer;">Agregar</button>
                        </div>
                        <input type="text" id="player-institution" placeholder="Institución (opcional)" style="width: 100%; box-sizing: border-box; padding: 8px; border-radius: 6px; border: 1px solid #ddd; font-size: 13px;"/>
                    </div>
                    <div id="top3-list">
                        <!-- Generado por JS -->
                    </div>
                    <button class="btn-reset-rank" onclick="resetRanking()">RESTABLECER RANKING</button>
                    <button class="btn-history" onclick="toggleModal()" style="position: relative;">
                        Mostrar tabla de puntajes histórica
                        <span id="history-badge" style="position: absolute; top: -8px; right: -8px; background: red; color: white; border-radius: 50%; padding: 2px 6px; font-size: 11px; font-weight: bold; display: none;">0</span>
                    </button>
                </div>
                ...
                <div id="instructions-container">
                    ...
                    <ol>
                        ...
                        <li>Ingresa tu nombre en el ranking a la izquierda y tu institución si lo deseas y dale a <b>Agregar</b>.</li>
                ...
                <div id="modal-overlay">
                    <div id="modal-history">
                        <div id="modal-close" onclick="toggleModal()">✖</div>
                ...
                <div id="password-overlay">
                    <div id="password-modal">
                        <h3>RESTABLECER RANKING</h3>
                        <p style="margin: 0 0 20px 0; text-align: center; color: #666; font-size: 14px;">Ingrese la contraseña de administrador:</p>
                        <div id="password-container">
                            <input type="password" id="password-input" placeholder="Contraseña" onkeypress="if(event.key==='Enter') submitPassword();">
                            <span id="toggle-password" onclick="togglePassword()" title="Mostrar/Ocultar contraseña">
                                <svg class="eye-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg>
                            </span>
                        </div>
                        <div class="pass-btn-group">
                            <button class="pass-btn pass-btn-cancel" onclick="closePasswordModal()">Cancelar</button>
